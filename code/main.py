...
if __name__ == '__main__':
    ...
    df = predict_and_save(config['DIRECTORIES']['validation'],
    ...
    plt.plot(df["Delay"][indices], label="Delay")
    plt.plot(df["Predicted_Delay"][indices], label="Predicted Delay")
    plt.legend()
    plt.title("Delay vs predicted delay")
    plt.xlabel("Sample number")
    plt.ylabel("Measured Delay")
    plt.savefig(os.path.join(config["DIRECTORIES"]["plot"], "Predicted_vs_Actual"))
    plt.figure()
